  ...
  return [
    {
      ...
      text: accountType === 'company'
        ? 'Ciao, sono l assistente Vygo. Dimmi cosa devi fare nel pannello azienda e ti guido passo passo.'
        : 'Ciao, sono l assistente Vygo. Dimmi cosa non trovi nell app e ti aiuto subito.',
    },
  ]
}
...
export function AssistantModal({
  ...
  async function openTicket() {
    ...
    const subject = encodeURIComponent(`Ticket Vygo - ${companyName}`)
      ...
      <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : undefined} style={styles.screen}>
        <View style={styles.header}>
          ...
          <View style={styles.headerCopy}>
            <Text numberOfLines={1} style={styles.title}>Assistente Vygo</Text>
