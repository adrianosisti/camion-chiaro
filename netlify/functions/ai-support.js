...
Vyko e un software per aziende di logistica e trasporto.
...
const supportPlaybooks = [
  {
    ...
    response: [
      'Per rinnovare una scadenza in Vyko fai cosi:',
  ...
  },
  {
    ...
    response: [
      ...
      '1. Apri Impostazioni nell app Vyko sul telefono interessato.',
      '2. Premi Attiva notifiche o Verifica notifiche.',
      '3. Controlla che i permessi iOS/Android siano attivi per Vyko.',
  ...
  },
  {
    ...
    response: [
      'I piani Vyko sono pensati per dimensione azienda:',
  ...
  },
  {
    ...
    response: [
      ...
      '4. Vyko deve evitare promesse legali automatiche: per GDPR, lavoro e conservazione dati va validato con consulente.',
  ...
  },
  {
    ...
    response: [
      'Le funzioni piu forti per far percepire Vyko come indispensabile sono:',
...
function buildSystemPrompt({ companyContext = {}, companyName = 'Azienda', language = 'it' }) {
  ...
  return `
Sei Assistente Vyko, supporto operativo per aziende di logistica.
Rispondi nella stessa lingua dell utente, con tono semplice, pratico e rassicurante.
Aiuta l utente a usare Vyko passo per passo: dashboard, scadenze, documenti, guasti, check mattutini, chat, notifiche, anagrafiche, flotta, costi e app mobile.
Non dire mai di poter modificare direttamente i dati se non hai uno strumento per farlo. Guida l utente su dove cliccare.
Se la domanda riguarda norme, lavoro, privacy, fiscalita o sicurezza, dai indicazioni operative generali e consiglia verifica con consulente o assistenza Vyko.
Se non sei sicuro, fai una sola domanda chiara oppure indirizza al centro supporto Vyko.
...
function buildGuidedAnswer(message) {
  ...
  return [
    ...
    'Appena capisco la sezione, ti do il percorso preciso dentro Vyko.',
  ].join('\n')
}
