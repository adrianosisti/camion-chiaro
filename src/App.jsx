...
const translations = {
  it: {
    ...
    'support.faq': 'FAQ',
    'support.launch': 'Attivazione',
    'support.manual': 'Uso quotidiano',
    'support.overline': 'Centro supporto',
    'support.subtitle': 'Procedure, FAQ e indicazioni operative per usare Vygo con ordine.',
    'support.title': 'Guida Vygo',
    'support.videos': 'Formazione',
    'support.vision': 'Funzioni avanzate',
  ...
  en: {
    ...
    'support.faq': 'FAQ',
    'support.launch': 'Activation',
    'support.manual': 'Daily use',
    'support.overline': 'Support center',
    'support.subtitle': 'Procedures, FAQs and operating guidance to use Vygo clearly.',
    'support.title': 'Vygo guide',
    'support.videos': 'Training',
    'support.vision': 'Advanced features',
  ...
  es: {
    ...
    'support.faq': 'FAQ',
    'support.launch': 'Activacion',
    'support.manual': 'Uso diario',
    'support.overline': 'Centro ayuda',
    'support.subtitle': 'Procedimientos, FAQ e indicaciones operativas para usar Vygo con orden.',
    'support.title': 'Guia Vygo',
    'support.videos': 'Formacion',
    'support.vision': 'Funciones avanzadas',
  ...
  fr: {
    ...
    'support.faq': 'FAQ',
    'support.launch': 'Activation',
    'support.manual': 'Usage quotidien',
    'support.overline': 'Centre support',
    'support.subtitle': 'Procedures, FAQ et indications operationnelles pour utiliser Vygo clairement.',
    'support.title': 'Guide Vygo',
    'support.videos': 'Formation',
    'support.vision': 'Fonctions avancees',
  ...
  de: {
    ...
    'support.faq': 'FAQ',
    'support.launch': 'Aktivierung',
    'support.manual': 'Tagliche Nutzung',
    'support.overline': 'Hilfecenter',
    'support.subtitle': 'Ablaufe, FAQ und operative Hinweise fur klare Nutzung von Vygo.',
    'support.title': 'Vygo Hilfe',
    'support.videos': 'Schulung',
    'support.vision': 'Erweiterte Funktionen',
...
const workflowTranslations = {
  it: {
    ...
    'drivers.checkPermissionActive': 'Check richiesto',
    'drivers.checkPermissionDisabled': 'Check non richiesto',
    'drivers.checkPermissionHelp': 'Attiva il flag se vuoi ricevere il check giornaliero da questo autista. Disattivalo se non deve compilarlo.',
  ...
  en: {
    ...
    'drivers.checkPermissionActive': 'Check required',
    'drivers.checkPermissionDisabled': 'Check not required',
    'drivers.checkPermissionHelp': 'Turn this on if this driver must send the daily check. Turn it off if the company does not require it.',
  ...
  es: {
    ...
    'drivers.checkPermissionActive': 'Check requerido',
    'drivers.checkPermissionDisabled': 'Check no requerido',
    'drivers.checkPermissionHelp': 'Activalo si este conductor debe enviar el check diario. Desactivalo si la empresa no lo requiere.',
  ...
  fr: {
    ...
    'drivers.checkPermissionActive': 'Check requis',
    'drivers.checkPermissionDisabled': 'Check non requis',
    'drivers.checkPermissionHelp': 'Activez cette option si ce chauffeur doit envoyer le check quotidien. Desactivez-la si l entreprise ne le demande pas.',
  ...
  de: {
    ...
    'drivers.checkPermissionActive': 'Check erforderlich',
    'drivers.checkPermissionDisabled': 'Check nicht erforderlich',
    'drivers.checkPermissionHelp': 'Aktivieren, wenn dieser Fahrer den Tagescheck senden muss. Deaktivieren, wenn das Unternehmen ihn nicht verlangt.',
...
const regionalTranslations = {
  ro: {
    ...
    'support.faq': 'FAQ',
    'support.launch': 'Activare',
    'support.manual': 'Utilizare zilnica',
    'support.overline': 'Centru suport',
    'support.subtitle': 'Proceduri, FAQ si indicatii operationale pentru a folosi Vygo ordonat.',
    'support.title': 'Ghid Vygo',
    'support.videos': 'Instruire',
    'support.vision': 'Functii avansate',
  },
  pl: {
    ...
    'support.faq': 'FAQ',
    'support.launch': 'Aktywacja',
    'support.manual': 'Codzienne uzycie',
    'support.overline': 'Centrum pomocy',
    'support.subtitle': 'Procedury, FAQ i wskazowki operacyjne do uporzadkowanego korzystania z Vygo.',
    'support.title': 'Pomoc Vygo',
    'support.videos': 'Szkolenie',
    'support.vision': 'Funkcje zaawansowane',
  },
}
...
const homeDashboardTranslations = {
  ...
  es: {
    ...
    'support.assistant': 'Primeros pasos',
  },
  fr: {
    'homeFlow.archive': 'Archive',
    ...
    'support.assistant': 'Premiers pas',
  },
  de: {
    ...
    'support.assistant': 'Erste Schritte',
  },
  ro: {
  ...
  pl: {
    ...
    'support.assistant': 'Pierwsze kroki',
  },
}
...
const supportSections = [
  {
    description: 'I passaggi essenziali per iniziare a usare Vygo in modo ordinato fin dal primo giorno.',
    icon: Bot,
    id: 'assistant',
    titleKey: 'support.assistant',
    items: [
      {
        body: 'Completa ragione sociale, sede, logo e lingua aziendale. Questi dati vengono mostrati nella dashboard, nell app del personale e nelle comunicazioni interne.',
        title: 'Configura l azienda',
      },
      {
        body: 'Inserisci autisti, ufficio e magazzino con username, telefono e ruolo. Ogni persona vede solo le aree abilitate per il proprio lavoro.',
      ...
      {
        body: 'Attiva le notifiche sui telefoni usati da titolare, ufficio e personale. Chat, guasti, check critici e solleciti diventano subito visibili.',
        title: 'Attiva notifiche',
      },
    ],
  },
  {
    description: 'Risposte semplici alle domande piu frequenti prima e dopo l attivazione.',
    icon: BadgeCheck,
    id: 'faq',
    titleKey: 'support.faq',
    items: [
      {
        body: 'Vygo unisce dashboard aziendale, app mobile, documenti, scadenze, chat, check, guasti, costi e report. L obiettivo e avere un unico punto di controllo operativo.',
        title: 'A cosa serve Vygo?',
      },
      {
        body: 'Riduce documenti dispersi, messaggi non tracciati, telefonate continue e scadenze ricordate troppo tardi. Ogni pratica resta collegata a persona, mezzo, data e storico.',
        title: 'Cosa cambia rispetto a WhatsApp ed Excel?',
      },
      {
        body: 'L azienda lavora dal browser desktop e puo usare anche l app. Autisti e personale usano l app iOS/Android per chat, documenti, check, guasti e notifiche.',
        title: 'Dove si usa?',
      },
      {
        body: 'No. L azienda crea credenziali e ruoli. Ogni utente vede solo informazioni e funzioni coerenti con il proprio profilo.',
        title: 'Tutti vedono tutto?',
      },
      {
        body: 'Si. I documenti visibili al personale possono essere aperti dall app anche quando serve mostrarli durante un controllo.',
        title: 'I documenti sono sempre disponibili?',
      },
      {
        body: 'Si. Ogni piano include le funzioni principali. Il prezzo cambia in base a numero di mezzi, strumenti, account e spazio file.',
        title: 'Le funzioni sono incluse nei piani?',
      },
      {
        body: 'Dal Centro costi puoi registrare manutenzioni, sanzioni, assicurazioni, revisioni, gomme e spese libere. I report filtrano per periodo, targa, persona, categoria o attrezzatura.',
        title: 'Come controllo le spese?',
      },
      {
        body: 'Le notifiche arrivano ai dispositivi abilitati. Se un telefono viene cambiato o un utente esce dall account, va verificata l attivazione dalle impostazioni app.',
        title: 'Come funzionano le notifiche?',
      },
    ],
  },
  {
    description: 'Manuale operativo per usare le funzioni principali senza chiamare ogni volta l ufficio.',
    icon: BookOpen,
    id: 'manual',
    ...
    items: [
      ...
      {
        points: ['L autista seleziona il mezzo usato.', 'Compila check, km e anomalie.', 'Se qualcosa non va, l azienda riceve una criticita da gestire.'],
        title: 'Check giornaliero',
      },
      {
        points: ['La segnalazione guasto arriva nel registro operativo.', 'Apri il dettaglio, valuta foto e note.', 'Archivia quando risolto e, se serve, registra costo e documento.'],
        title: 'Guasti',
      },
      {
        points: ['Apri Chat.', 'Scegli chat singole o gruppi.', 'I messaggi non letti restano evidenziati.', 'Allegati, audio e video restano collegati alla conversazione.'],
        title: 'Chat aziendale',
      },
      {
        points: ['Apri Centro costi.', 'Registra spese, multe o manutenzioni.', 'Collega targa, persona o attrezzatura.', 'Usa Report per esportare CSV o stampare il riepilogo.'],
        title: 'Costi e report',
      },
    ],
  },
  {
    description: 'Indicazioni per mettere Vygo a regime in azienda senza creare confusione tra ufficio, autisti e magazzino.',
    icon: FileText,
    id: 'launch',
    titleKey: 'support.launch',
    items: [
      {
        body: 'Prima di invitare tutto il personale, completa dati azienda, flotta, persone, documenti principali e prime scadenze. Una configurazione ordinata rende l adozione molto piu semplice.',
        title: 'Preparazione',
      },
      {
        body: 'Definisci il lavoro di ogni reparto: l ufficio gestisce scadenze e pratiche, gli autisti inviano check e guasti, il magazzino usa strumenti e comunicazioni assegnate.',
        title: 'Ruoli chiari',
      },
      {
        body: 'Fai una prova reale con pochi utenti: un check, un guasto con foto, un documento rinnovato, una chat e una spesa. Se tutto scorre, estendi l uso al resto dell azienda.',
        title: 'Prima settimana',
      },
      {
        body: 'Ogni pratica va chiusa, rinnovata o archiviata quando e stata gestita. Tenere la dashboard pulita aiuta il titolare a vedere solo cio che richiede attenzione.',
        title: 'Regola operativa',
      },
    ],
  },
  {
    description: 'Percorsi brevi per formare rapidamente chi usa Vygo ogni giorno.',
    icon: Smartphone,
    id: 'videos',
  ...
  {
    description: 'Funzioni avanzate pensate per aumentare controllo, prevenzione e qualita operativa.',
    icon: ShieldCheck,
    id: 'vision',
    titleKey: 'support.vision',
    items: [
      {
        body: 'Ogni mezzo riceve un punteggio basato su scadenze, guasti, check critici e costi recenti. Il titolare capisce subito dove intervenire.',
        title: 'Indice salute flotta',
      },
      {
        body: 'Report periodici con costi per targa, multe per persona, guasti ricorrenti, scadenze chiuse e pratiche ancora aperte.',
        title: 'Report direzionali',
      },
      {
        body: 'Budget mensili per mezzo, attrezzatura o categoria. Quando una soglia viene superata, Vygo evidenzia il problema.',
        title: 'Controllo budget',
      },
      {
        body: 'Rilevazione di guasti ricorrenti sulla stessa targa o tipologia di mezzo, utile per programmare manutenzione preventiva.',
        title: 'Recidive e prevenzione',
      },
      {
        body: 'Indicatori su documenti rinnovati in ritardo, sanzioni, check critici e anomalie ripetute, utili per formazione e procedure interne.',
        title: 'Formazione mirata',
      },
      {
        body: 'Estensione della stessa logica a magazzino, muletti, attrezzature, DPI, visite mediche e scadenze operative.',
        title: 'Moduli reparto',
      },
    ],
  },
]
      ...
      >
        ...
        <div className="legal-document-body">
          ...
          <p className="legal-document-warning">
            Per chiarimenti su privacy, condizioni o gestione dati, contatta l assistenza Vygo o il referente aziendale.
          </p>
        </div>
...
function AdminWorkspace({
  ...
  function getAdminRecommendation(company) {
    ...
    if (company.usageScore < 58) return 'Utilizzo ancora basso: aiuta il cliente a caricare anagrafiche, mezzi, documenti e primo giro operativo.'
  ...
  return (
    <section className="admin-workspace" aria-label="Osservatorio interno Vygo">
      ...
      <div className="admin-kpi-grid">
        ...
        <article className={summary.weekActivityCount ? 'is-money' : 'is-warning'}>
          <ClipboardCheck size={20} />
          <strong>{summary.weekActivityCount ?? 0}</strong>
          <span>Attività ultimi 7 giorni</span>
        </article>
        <article>
          <CheckCircle2 size={20} />
          <strong>{summary.readyCompanyCount ?? 0}</strong>
          <span>Aziende ben configurate</span>
        </article>
      ...
      <p className="admin-status-line">
        {statusMessage || 'Pannello aggiornato.'} · Fatture incassate questo mese: {formatMoneyCents(summary.invoiceMonthCents, 'EUR')} · Aziende attive: {summary.activeCompanies} · Attività 7 giorni: {summary.weekActivityCount ?? 0}
      </p>
              ...
              <tbody>
                {filteredCompanies.map((company) => (
                  ...
                  >
                    ...
                    <td>
                      <strong>{company.usageScore ?? 0}%</strong>
                      <span>{company.weekActivityCount ?? 0} eventi 7g</span>
                    </td>
                    <td>
          ...
          {selectedCompany ? (
            <>
              ...
              <div className="admin-detail-grid">
                ...
                <div>
                  <span>Indice utilizzo</span>
                  <strong>{selectedCompany.usageScore ?? 0}%</strong>
                </div>
                <div>
              ...
              <div className={`admin-activity-card tone-${getUsageReadinessTone(selectedCompany.usageScore ?? 0)}`}>
                <div className="admin-activity-head">
                  <div>
                    <strong>Storico attività azienda</strong>
                    <span>Solo dati reali: cosa ha creato, inviato, caricato o gestito il cliente.</span>
                  </div>
                  <b>{selectedCompany.usageScore ?? 0}%</b>
                </div>
                <div className="admin-activity-checks">
                  {(selectedCompany.usageChecklist ?? []).map((item) => (
                ...
                {selectedCompany.activityTimeline?.length ? (
                  <div className="admin-activity-thread">
                    {selectedCompany.activityTimeline.map((entry) => (
                      <article className="is-client" key={entry.id}>
                        <strong>{entry.title}</strong>
                        <div className="admin-activity-thread-tags">
                  ...
                  <p>Nessuna attività ancora registrata per questo cliente.</p>
                )}
              </div>
...
function getUsageReadinessTone(score = 0) {
