...
begin
  ...
  values
    ...
    (all_thread_id, target_company_id, owner_user_id, null, 'company', 'Demo Vygo: chat gruppi, dirette, scadenze e anomalie pronte da provare.', now() - interval '30 minutes'),
